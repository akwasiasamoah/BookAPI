...
namespace BookApi_Project.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        //TO DO - need to test it after we implemet IBook repository
        ...
        public IActionResult UpdateCategory(int categoryId, [FromBody]Category updatedCategoryInfo)
        {
            ...
            {
                ModelState.AddModelError("", $"Category {updatedCategoryInfo.Name} already exist");
                StatusCode(422, ModelState);
            }
        ...
        public IActionResult DeleteCategory(int categoryId)
        {
            ...
            {
                ModelState.AddModelError("", $"Category {categoryToDelete.Name} cannot be deleted because it is used by at least one author");
            ...
            {
                ModelState.AddModelError("", $"Something happened trying delete {categoryToDelete.Name}");
                StatusCode(500, ModelState);
            }
